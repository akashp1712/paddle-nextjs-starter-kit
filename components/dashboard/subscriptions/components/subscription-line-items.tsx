        ...
        <div className={'grid grid-cols-12'}>
          ...
          <div className={'flex gap-6 w-full col-span-6'}>
            ...
            <div className={'col-span-2 w-full text-base leading-4 font-semibold text-right'}>
              <span>Amount</span>
              <span className={'text-muted-foreground text-sm leading-[14px] font-normal'}>(exc. tax)</span>
            </div>
          </div>
                ...
                <div className={'col-span-6 border-border border-b py-6'}>
                  <div className={'flex gap-4 items-center'}>
                    ...
                    <div className={'flex flex-col gap-3 px-4'}>
                      ...
                      <div className={'text-base leading-6 text-muted-foreground'}>{lineItem.product.description}</div>
                    </div>
                  </div>
                </div>
                <div className={'flex gap-6 w-full col-span-6 items-center border-border border-b py-6'}>
                  <div className={'col-span-2 w-full text-base leading-4 font-semibold text-muted-foreground'}>
                    {lineItem.quantity}
                  </div>
                  <div className={'col-span-2 w-full text-base leading-4 font-semibold text-muted-foreground'}>
                    {parseFloat(lineItem.taxRate) * 100}%
                  </div>
                  <div className={'col-span-2 text-right w-full text-base leading-4 font-semibold text-muted-foreground'}>
          ...
          <div className={'flex flex-col w-full col-span-6 pt-6'}>
            <div className={'flex justify-between py-4 pt-0 border-border border-b'}>
              <div className={'col-span-3 w-full text-base leading-4 text-muted-foreground'}>Amount</div>
              <div className={'col-span-3 w-full text-base leading-4 text-right text-muted-foreground'}>
            ...
            <div className={'flex justify-between py-4 border-border border-b'}>
              <div className={'col-span-3 w-full text-base leading-4 text-muted-foreground'}>Tax</div>
              <div className={'col-span-3 w-full text-base leading-4 text-right text-muted-foreground'}>
                {parseMoney(subscription?.recurringTransactionDetails?.totals.tax, subscription?.currencyCode)}
              </div>
            </div>
            <div className={'flex justify-between py-4 border-border border-b'}>
              <div className={'col-span-3 w-full text-base leading-4 text-muted-foreground'}>Total (Inc. tax)</div>
